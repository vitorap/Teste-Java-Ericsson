# Teste de Java - Ericsson
Teste de Java referente a vaga de desenvolvedor na Ericsson
Código final correspondente a prova recebida por email (tambem no diretorio)

# Considerações
  * Testado com o JDK 11
  * Todas features e chamadas estao funcionando
  * O endereço url de todas chamadas está exatamente como na prova
  * Excessoes comuns foram tratadas, como retornar um NotFound para caso nao encontre um stock na chamada de get
  * Todos testes unitarios funcionando
  * Foi usado o software Postman para testar as chamadas
  * O banco MySQL usado foi local da maquina, e um script SQL que cria e popula (se desejado) os bancos de dados foi disponibilizado
  * O script SQL se encontra em /src/main/resources e tambem em /src/test/resources e ao final desse readme
  * É necessario criar os Bancos MySQL localmente para rodar o programa
  * O ambiente de testes e de desenvolvimento usam bancos diferentes, o BD para ambiente de produçao deve se chamar "stockdb" e o BD para ambiente de testes deve se chamar "test".
  * A classe de testes é a apiTest
  * A identaçao do codigo foi feita com um script que eu gosto, mas caso nao agrade, podemos trocar o padrao de identaçao no futuro.  
  
  
  Por fim, mas nao menos importante, aprendi muito com esse teste, agradeço o incentivo e oportunidade.

Qualquer duvida nao hesite em falar comigo.


Segue abaixo o Script MySQL
